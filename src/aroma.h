...
//
#define AROMA_BUILD_A     "<@Samuel9611 - @AlexFurina>"
#define AROMA_BUILD_URL   "@XRom70 on Telegram"
#define AROMA_COPY        "(C) 2023 - 2025 Samuel - Alex for XROM\n(C) 2013-2017 amarullz xda-developers"
#define AROMA_COPY_NS1    "(C) 2023 - 2025 Samuel - Alex for XROM, and"
...
#define AROMA_TMP         AROMA_SYSTMP "/installer"
#define AROMA_TMP_S       AROMA_SYSTMP "/installer-data"

#define AROMA_DIR         "META-INF/com/google/android/installer-data"
#define AROMA_UPDATESCRPT "META-INF/com/google/android/updater-script"
#define AROMA_CFG         "META-INF/com/google/android/installer-cfg"
#define AROMA_ORIB        "META-INF/com/google/android/installrr-bin"
